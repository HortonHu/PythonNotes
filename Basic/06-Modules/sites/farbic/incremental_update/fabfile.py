...
def update(*modules):
    ...
    # put(os.path.join(BASE_DIR, '1.txt'), '/home/horton/md5_test/files/', use_sudo=True)

    get('/home/horton/md5_test/1.txt', os.path.join(BASE_DIR, 'files', '1.txt'), use_sudo=True)
