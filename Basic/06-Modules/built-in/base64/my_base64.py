...
# 然后，对二进制数据进行处理，每3个字节一组，一共是3x8bit=24bit，划为4组，每组正好6个bit：
...
# Base64用一个字节的\x00在末尾补足后，再在编码的末尾加上1个或2个=号，表示补了多少字节，解码的时候，会自动去掉。


# Python内置的base64可以直接进行base64的编解码：
import base64
print base64.b64encode('binary\x60string')      # 注意\x60长度为1  16进制的字符 总长度为13 补了两个=
print base64.b64decode('YmluYXJ5YHN0cmluZw==')
